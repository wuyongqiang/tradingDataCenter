...
import grant.wu.migration.MigrationScheduleInt;
import grant.wu.migration.PM;
import grant.wu.migration.VM;
import grant.wu.util.LogPrint;
...
public class SimulationAnneal implements MigrationScheduleInt {
	...
	protected int iTeration = 2500;//1000;
	...
	protected int annealTimeLimit = 500*100; //500
	...
	LogPrint logPrint = new LogPrint(this.getClass().getName()+".txt");
	...
	protected void printResult() {
		...
		String strResult = "";
		strResult ="progress \t" + (String.format("%.1f", tick)
				+ "\t"
				+ totalIteration
				+ "\t "
	...
	protected void saveResult() {
		...
		strResult ="saveResult \t" + (String.format("%.1f", tick)
				+ "\t"
				+ totalIteration
				+ "\t "
				+ String.format("%.2f", sofarBest)
